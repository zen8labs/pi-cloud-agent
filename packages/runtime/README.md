...
- **No profile code here.** The controller composes skill and prompt into one finished `TASK_PROMPT`, so the image ships nothing about any vertical or plugin package.
