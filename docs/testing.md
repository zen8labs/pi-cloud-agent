...
| `apps/controller/reconcile/reconciler.integration.test.ts` | restart safety, checkpoint replacement/expiry, workspace suspend/resume, and cold fallback |
