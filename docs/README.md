...
| [adding-an-integration.md](adding-an-integration.md) | an external event source, webhook projection, and structured provider actuation |

## Working on the core

| Document | For |
|---|---|
| [resumability.md](resumability.md) | run/session state, provider checkpoints, retention, and the reconciler |
